...
This app is a generated ditto.site clone. The generator captured the source pages, normalized the rendered DOM into an IR, inferred assets/tokens/sections/recipes, and emitted a static Vite React project.

## Structure

- `index.html` and route HTML files: Vite HTML entries with captured language, metadata, JSON-LD, and body attributes.
- `src/routes/*/page.tsx` files: generated route bodies.
...
- / - myrtletribe
- /artwork - myrtletribe
- /not_found - myrtletribe
- /info/about - myrtletribe
- /gallery/artwork - myrtletribe
- /gallery/photography - myrtletribe
- /guest/guestbook - myrtletribe
- /guest/links - myrtletribe
- /library/blog - myrtletribe
- /library/reading-log - myrtletribe
- /library/snapshots - myrtletribe
- /scrapbook/palettes - myrtletribe
